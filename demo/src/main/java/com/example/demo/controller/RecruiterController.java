...
public class RecruiterController {
    ...
    public Map<String, Long> recruiterDashboard() {
        ...
        long jobs = jobRepository.countByRecruiterId(recruiter.getRecruiterId());

        List<Job> recruiterJobs = jobRepository.findByRecruiterId(recruiter.getRecruiterId());

        List<Integer> jobIds = recruiterJobs.stream()
                .map(Job::getJobId)
                .toList();

        long applications = applicationRepository.countByJobIdIn(jobIds);
    ...
    public Map<String,Object> recruiterAnalytics(){
    ...
    List<Job> jobs = jobRepository.findByRecruiterId(recruiter.getRecruiterId());
    ...
    long selectedStudents =
            applicationRepository.countByJobIdInAndStatus(jobIds,"SELECTED");

    long inProgress =
            applicationRepository.countByJobIdInAndStatus(jobIds,"IN_PROGRESS");

    long rejected =
            applicationRepository.countByJobIdInAndStatus(jobIds,"REJECTED");

    Map<String,Object> stats = new HashMap<>();

    stats.put("jobs", totalJobs);
    stats.put("applications", totalApplications);
    stats.put("selected", selectedStudents);
    ...
    return jobRepository.findByRecruiterId(recruiter.getRecruiterId());
